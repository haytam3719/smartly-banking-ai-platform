---
document_id: transfers-transfer-processing-times
document_type: transfer_processing
title: Délais de virement
language: fr
version: "3.0"
synthetic: true
domain: transfers
...
## Objet et périmètre
Un virement domestique standard prend généralement un jour ouvré, un instantané quelques secondes s’il est éligible, et un international deux à cinq jours ouvrés. Les contrôles, devises, fuseaux horaires et banques correspondantes peuvent prolonger ces délais.
...
## Exemple de question
« Délais de virement : quelles règles, quels états et quelle action sont applicables ? »
