---
document_id: cards-cash-withdrawal-limits
...
## Objet et périmètre
Le plafond de retrait cumule les espèces retirées sur 7 jours glissants et reste indépendant du plafond de paiement. L’exploitant du distributeur peut imposer une limite inférieure par opération et afficher ses propres frais.
...
## Exemple de question
« Plafond de retrait : quelles règles, quels états et quelle action sont applicables ? »
