---
document_id: security-device-security
document_type: security
title: Sécuriser l'application bancaire et l'appareil
language: fr
version: "3.0"
synthetic: true
domain: security
...
# Sécuriser l'application bancaire et l'appareil

Documentation synthétique destinée à l'environnement de démonstration Smartly Banking AI.

## Objet et périmètre
Maintenir système et application à jour, activer verrouillage et chiffrement, éviter les appareils rootés et supprimer les applications douteuses. Sur Wi-Fi public, ne pas ignorer les alertes de certificat et préférer un réseau de confiance.
...
## Exemple de question
« Sécurité de l’appareil : quelles règles, quels états et quelle action sont applicables ? »
