---
document_id: account-opening-account-opening-steps
document_type: account_opening
title: Étapes d’ouverture d’un compte
language: fr
version: "3.0"
synthetic: true
...
# Étapes d’ouverture d’un compte

Documentation synthétique destinée à l'environnement de démonstration Smartly Banking AI.

## Objet et périmètre
Le parcours informatif comprend choix du type de compte, saisie des données, dépôt des justificatifs, consentements, KYC, revue puis notification.
...
## Exemple de question
« Étapes d’ouverture d’un compte : quelles règles, quels états et quelle action sont applicables ? »
