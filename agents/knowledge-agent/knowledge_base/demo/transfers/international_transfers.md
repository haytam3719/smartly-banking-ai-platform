---
document_id: transfers-international-transfers
document_type: international_transfers
...
## Objet et périmètre
Un virement international peut exiger IBAN ou numéro de compte, BIC/SWIFT, nom et adresse du bénéficiaire, devise et motif. Les banques intermédiaires, contrôles de conformité et jours fériés influencent le délai.
...
## Exemple de question
« Virements internationaux : quelles règles, quels états et quelle action sont applicables ? »
