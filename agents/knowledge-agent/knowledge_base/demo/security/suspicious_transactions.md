---
document_id: security-suspicious-transactions
...
## Objet et périmètre
Une opération inconnue, un montant inhabituel ou une série de petits tests doit être signalé rapidement. Le client bloque le moyen de paiement concerné, sécurise son accès et utilise le canal de contestation authentifié.
...
## Exemple de question
« Transactions suspectes : quelles règles, quels états et quelle action sont applicables ? »
