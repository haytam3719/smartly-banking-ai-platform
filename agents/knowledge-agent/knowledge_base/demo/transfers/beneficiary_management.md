---
document_id: transfers-beneficiary-management
document_type: beneficiary_management
...
## Objet et périmètre
L’ajout ou la modification d’un bénéficiaire exige une authentification renforcée et peut déclencher un délai de sécurité de quatre heures. Le client vérifie l’IBAN par un canal indépendant; la banque ne garantit pas que le nom saisi corresponde au compte.
...
## Exemple de question
« Gestion des bénéficiaires : quelles règles, quels états et quelle action sont applicables ? »
