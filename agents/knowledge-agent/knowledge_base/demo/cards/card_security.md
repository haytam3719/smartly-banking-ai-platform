---
document_id: cards-card-security
...
## Objet et périmètre
Le code PIN, le cryptogramme et les codes OTP ne doivent jamais être communiqués. Le client masque le clavier, active les alertes, contrôle régulièrement ses opérations et bloque la carte au moindre doute.
...
## Exemple de question
« Sécurité de la carte : quelles règles, quels états et quelle action sont applicables ? »
