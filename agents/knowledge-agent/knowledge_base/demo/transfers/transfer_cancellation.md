---
document_id: transfers-transfer-cancellation
document_type: transfer_processing
title: Annulation d’un virement
language: fr
version: "3.0"
synthetic: true
domain: transfers
...
## Objet et périmètre
Un virement programmé peut être annulé avant 20 h la veille de son exécution. Un ordre encore en attente peut parfois être retiré; un ordre exécuté ou transmis est irrévocable et seule une demande de rappel, sans garantie, reste possible.
...
## Exemple de question
« Annulation d’un virement : quelles règles, quels états et quelle action sont applicables ? »
