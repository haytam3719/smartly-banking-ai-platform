---
document_id: cards-online-payments
...
## Objet et périmètre
Les paiements en ligne peuvent nécessiter une authentification renforcée dans l’application. Le client vérifie commerçant, montant et devise avant validation. Les cartes virtuelles et la désactivation des achats internet réduisent l’exposition.
...
## Exemple de question
« Paiements en ligne : quelles règles, quels états et quelle action sont applicables ? »
