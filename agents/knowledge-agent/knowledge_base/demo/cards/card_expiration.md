---
document_id: cards-card-expiration
document_type: card_lifecycle
title: Expiration d’une carte
language: fr
version: "3.0"
synthetic: true
domain: cards
...
## Objet et périmètre
Une carte fonctionne jusqu’à la fin du mois imprimé. Une carte de renouvellement est normalement proposée avant l’échéance si le compte reste éligible. Les abonnements doivent être mis à jour si le commerçant ne reçoit pas automatiquement les nouvelles références.
...
## Exemple de question
« Expiration d’une carte : quelles règles, quels états et quelle action sont applicables ? »
